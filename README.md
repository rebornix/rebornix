...
- [VS Code](https://github.com/microsoft/vscode), where I work on editor UX, notebooks/Jupyter, search, remote development, `vscode.dev`, and agentic coding experiences.
- [VS Code Copilot Chat](https://github.com/microsoft/vscode-copilot-chat), including recent work around Copilot coding agent, Copilot CLI, and Agent Sessions.
